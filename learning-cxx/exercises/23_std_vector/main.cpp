...
int main(int argc, char **argv) {
    {
        ...
        ASSERT(sizeof(vec) == sizeof(int *) * 3, "Fill in the correct value.");
        int ans[]{1, 2, 3, 4, 5};
    ...
    }
    {
        ...
        {
            ASSERT(vec.size() == 5, "Fill in the correct value.");
            ASSERT(sizeof(vec) == sizeof(double *) * 3, "Fill in the correct value.");
    ...
    }
    {
        ...
        ASSERT(sizeof(vec) == sizeof(char *) * 3, "Fill in the correct value.");
        {
